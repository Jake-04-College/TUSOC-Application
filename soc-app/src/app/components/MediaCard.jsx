...
import CardContent from '@mui/materials/Card';
import CardHeader from '@mui/materials/Card';
import CardActions from '@mui/materials/Card';
import Typography from '@mui/materials/Card';
...
export default function MediaCard({username, timePosted, title, likes, comments}){
    return (
        <Card sx={{maxWidth: 500, mb: 2}}>
            <CardHeader title={username} sub header={timeSincePost(timePosted)}/>
